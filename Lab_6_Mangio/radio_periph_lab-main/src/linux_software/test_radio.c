...
void print_benchmark(volatile unsigned int *periph_base)
{
	...
	printf("Register overflow, transfer throughput invalid\n");
	throughput = 976562.5/((stop_time-start_time)); //.0078125 Mbytes are transfered, 125Mhz clock speed, 
...
// first, get a pointer to the peripheral base address using /dev/mem and the function map
    volatile unsigned int *my_periph = get_a_pointer(RADIO_PERIPH_ADDRESS);	

    printf("\r\n\r\n\r\nLab 6 Anthony Mangio - Custom Peripheral Demonstration\n\r");
